...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-danger text-white">{{ __('Registro de Usuario') }}</div>
                ...
                <div class="card-body bg-danger p-2 text-dark bg-opacity-25">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="password"
                                class="col-md-4 col-form-label text-md-end">{{ __('Su Contraceña') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm"
                                class="col-md-4 col-form-label text-md-end">{{ __('Confirmar Contraceña') }}</label>
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label-center" for="remember">
                                {{ __('Al registrarme acepto los terminos y condiciones') }}
                            </label>
                        </div>
